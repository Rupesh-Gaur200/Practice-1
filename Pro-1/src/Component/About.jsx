    ...
    return (
        <div className=" w-full h-screen bg-[#0a192f] text-gray-300">
            <div className=" flex flex-col justify-centerout items-center w-full h-full">
               ...
               <div className=" hover:translate-x-(-5) hover:scale-125 duration-300 sm:text-right pb-8 pl-4">
                   <p className="  text-4xl font-bold inline border-b-4 border-purple-600">About</p>
                        ...
                        <div className="grid grid-cols-2 gap-20">
                          ...
                          <div className="pt-20">
                          <p className="text-2xl text-gray-300">Seeking a position in the field of 
