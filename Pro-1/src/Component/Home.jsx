    ...
    <div className=" w-full h-screen bg-[#0a192f]">
      ...
      <div className=" max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
        ...
        <h2 className="text-4xl text-gray-200">I am Frontend Developer</h2>
         ...
         <div>
        <button to="Work" onClick={handle} className="group text-white border-2 px-6 py-3 my-2 flex items-center hover:bg-purple-600 hover:border-purple-600">View Work 
