    ...
    return (
        ...
        <div name="Contact" className="w-full h-screen bg-[#0a192f] text-gray-300 pt-10 " >
         ...
         <div className="flex justify-center pt-24 ">
              ...
              <div className="w-[800px] h-[500px] border-8 border-purple-600 flex justify-center pr-8 ">
                 <div className=" border-2 border-purple-600 w-[625px] h-[450px] ml-8 mt-4">
                <form className=" flex flex-col gap-8">
                    ...
                    <textarea  className="ml-3 mt-3 mr-3 pl-3  h-[200px]"type="text" value="please drop your message here"></textarea>
                      ...
                      <button className="border-2 border-white w-[200px] ml-52 h-10 ">Let's Collabrate</button>
